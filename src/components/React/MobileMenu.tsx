  ...
  return (
    ...
    >
      <nav className="h-full px-4 pt-8">
        ...
        <div className="mt-8 flex flex-col items-center justify-center rounded-xl border p-3 text-center text-xl">
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          {socialLinks.map(({ url, label, name }) => (
            <a
              ...
              rel="noopener noreferrer"
              aria-label={label}
              className="transition-all duration-200 ease-in-out hover:scale-110 hover:text-blue-600"
            >
              {name === 'X' && (
                <svg
